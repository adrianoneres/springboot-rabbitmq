package com.example.tiao.configurations;
...
public class MessaginConfiguration {
  ...
  public Queue directMessagesQueue() {
    return new Queue("q.directmessages.tiao");
  }
  ...
  public Queue developersQueue() {
    return new Queue("q.developers.tiao");
  }
  ...
  public Queue alertsQueue() {
    return new Queue("q.alerts.tiao");
  }
