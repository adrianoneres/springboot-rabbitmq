package com.example.tieta.configurations;
...
public class MessaginConfiguration {
  ...
  public Queue directMessagesQueue() {
    return new Queue("q.directmessages.tieta");
  }
  ...
  public Queue developersQueue() {
    return new Queue("q.developers.tieta");
  }
  ...
  public Queue alertsQueue() {
    return new Queue("q.alerts.tieta");
  }
